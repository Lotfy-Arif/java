...
public class CreateAccount extends HttpServlet {
    ...
    protected void doPost( HttpServletRequest request, HttpServletResponse response )
        ...
        // error check for duplication
        if( aLogic.getAccountWithUsername( username ) == null ){
            try {
                Account account = aLogic.createEntity( request.getParameterMap() );
                // using the id of the dependency,
                // use the logic of the dependency to get the entity form DB using id
                // set the dependency on your object
